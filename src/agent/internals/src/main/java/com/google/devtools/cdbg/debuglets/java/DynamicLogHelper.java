 ...
 *
 * <p>The main reason this class exists is that native code can't call {@link
 * Logger#getLogger(String)}. The call just fails with {@link NullPointerException} because the
 * caller class is not defined.
 */
