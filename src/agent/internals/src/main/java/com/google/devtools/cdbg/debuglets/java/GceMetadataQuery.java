 ...
 * 
 * <p>The metadata service is explained
 * <a href="https://developers.google.com/compute/docs/metadata">here</a>.
 */
public final class GceMetadataQuery implements MetadataQuery {
  ...
  /**
   * Base URL for metadata service. Specific attributes are appended to this URL. Unit test
   * may override it to inject a mock HTTP client.
   */
  ...
  public GceMetadataQuery() throws MalformedURLException {
    this(new URL(System.getProperty("com.google.cdbg.metadataservicebase",
                                    DEFAULT_LOCAL_METADATA_SERVICE_BASE)));
  }
  ...
  void lazyQueryAccessToken() {
    ...
    if ((accessToken != null)
        && (startTime + CACHE_BUFFER_SEC < accessTokenExpirationTime)) {
