...
final class ResolvedSourceLocation {
  ...
  public ResolvedSourceLocation(
      String classSignature, String methodName, String methodDescriptor, int adjustedLineNumber) {
  ...
  /**
   * Returns null if source location was resolved successfully or a parameterized string with error
   * message otherwise.
   *
   * <p>The user of this class should call {@code getErrorMessage} first to determine whether the
   * source location resolution was successful. If it wasn't other methods of this class should not
   * be called.
   */
