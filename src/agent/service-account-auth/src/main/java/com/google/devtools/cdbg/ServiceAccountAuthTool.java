 ...
 *
 * <p>Syntax: ServiceAccountAuthTool <file>
 */
public final class ServiceAccountAuthTool {
  public static void main(String[] args) throws Exception {
    if (args.length != 1) {
      throw new IllegalArgumentException("Require JSON file as argument");
    }

    String jsonFile = args[0];
    ServiceAccountAuth auth = new ServiceAccountAuth(jsonFile);
