 ...
 *
 * $Id: //depot/code/org.antlr/release/antlr-2.7.2/lib/cpp/src/CommonAST.cpp#1 $
 */
...
string CommonAST::getText() const
{
	return text;
}
...
void CommonAST::initialize(int t,const string& txt)
{
	setType(t);
	setText(txt);
}
...
void CommonAST::setText(const string& txt)
{
	text = txt;
}
