 ...
 *
 * $Id: //depot/code/org.antlr/release/antlr-2.7.2/lib/cpp/src/CommonASTWithHiddenTokens.cpp#1 $
 */
...
void CommonASTWithHiddenTokens::initialize(int t,const string& txt)
{
